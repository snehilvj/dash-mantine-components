...
multiSelect <- function(id=NULL, className=NULL, clearSearchOnBlur=NULL, clearSearchOnChange=NULL, clearable=NULL, data=NULL, description=NULL, disabled=NULL, error=NULL, initiallyOpened=NULL, label=NULL, limit=NULL, maxDropdownHeight=NULL, maxSelectedValues=NULL, multiline=NULL, nothingFound=NULL, placeholder=NULL, radius=NULL, required=NULL, searchable=NULL, size=NULL, style=NULL, switchDirectionOnFlip=NULL, value=NULL, variant=NULL, withinPortal=NULL, zIndex=NULL) {
    ...
    component <- list(
        ...
        propNames = c('id', 'className', 'clearSearchOnBlur', 'clearSearchOnChange', 'clearable', 'data', 'description', 'disabled', 'error', 'initiallyOpened', 'label', 'limit', 'maxDropdownHeight', 'maxSelectedValues', 'multiline', 'nothingFound', 'placeholder', 'radius', 'required', 'searchable', 'size', 'style', 'switchDirectionOnFlip', 'value', 'variant', 'withinPortal', 'zIndex'),

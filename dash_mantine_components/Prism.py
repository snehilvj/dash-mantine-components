...
- withLineNumbers (boolean; optional):
    ...
    @_explicitize_args
    def __init__(self, class_name=Component.UNDEFINED, code=Component.REQUIRED, colorScheme=Component.UNDEFINED, copiedLabel=Component.UNDEFINED, copyLabel=Component.UNDEFINED, highlightLines=Component.UNDEFINED, id=Component.UNDEFINED, language=Component.REQUIRED, noCopy=Component.UNDEFINED, style=Component.UNDEFINED, withLineNumbers=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'class_name', 'code', 'colorScheme', 'copiedLabel', 'copyLabel', 'highlightLines', 'language', 'noCopy', 'style', 'withLineNumbers']
        self._type = 'Prism'
        self._namespace = 'dash_mantine_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'class_name', 'code', 'colorScheme', 'copiedLabel', 'copyLabel', 'highlightLines', 'language', 'noCopy', 'style', 'withLineNumbers']

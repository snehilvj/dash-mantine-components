...
- showLabel (string; default "Show more"):
    ...
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, hideLabel=Component.UNDEFINED, initialState=Component.UNDEFINED, maxHeight=Component.UNDEFINED, loading_state=Component.UNDEFINED, showLabel=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'hideLabel', 'initialState', 'loading_state', 'maxHeight', 'showLabel']
        self._type = 'Spoiler'
        self._namespace = 'dash_mantine_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'hideLabel', 'initialState', 'loading_state', 'maxHeight', 'showLabel']

...
- zIndex (number; optional):
    Popper z-index."""
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, arrowSize=Component.UNDEFINED, className=Component.UNDEFINED, color=Component.UNDEFINED, delay=Component.UNDEFINED, disabled=Component.UNDEFINED, gutter=Component.UNDEFINED, label=Component.REQUIRED, placement=Component.UNDEFINED, position=Component.UNDEFINED, width=Component.UNDEFINED, withArrow=Component.UNDEFINED, wrapLines=Component.UNDEFINED, style=Component.UNDEFINED, zIndex=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'arrowSize', 'className', 'color', 'delay', 'disabled', 'gutter', 'label', 'placement', 'position', 'style', 'width', 'withArrow', 'wrapLines', 'zIndex']
        self._type = 'Tooltip'
        self._namespace = 'dash_mantine_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'arrowSize', 'className', 'color', 'delay', 'disabled', 'gutter', 'label', 'placement', 'position', 'style', 'width', 'withArrow', 'wrapLines', 'zIndex']

...
function button(; kwargs...)
        available_props = Symbol[:children, :id, :class_name, :color, :compact, :disabled, :fullWidth, :gradient, :loaderPosition, :loading, :loading_state, :n_clicks, :radius, :size, :style, :uppercase, :variant]
        wild_props = Symbol[]

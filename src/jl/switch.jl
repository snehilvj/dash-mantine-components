...
- `offLabel` (String; optional): The inner label to be set when Switch is in an unchecked state
- `onLabel` (String; optional): The inner label to be set when Switch is in the checked state
...
function switch(; kwargs...)
        available_props = Symbol[:id, :checked, :class_name, :color, :disabled, :label, :offLabel, :onLabel, :radius, :size, :style]
        wild_props = Symbol[]

...
import { CloseButtonProps, MantineStylesAPIProps, MantineStyleSystemProps, ModalBaseOverlayProps, ModalBaseSettings } from "props/mantine";
...
type Props = {
  ...
  overlayProps?: ModalBaseOverlayProps & DashBaseProps & MantineStylesAPIProps & MantineStyleSystemProps
  /** Determines whether close button should be rendered, true by default */
  withCloseButton?: boolean;
  /** Props added to close button */
  closeButtonProps?: CloseButtonProps & MantineStyleSystemProps & MantineStylesAPIProps & DashBaseProps;
  /** Drawer Content **/
  children?: React.ReactNode;
} & ModalBaseSettings & DashBaseProps & MantineStyleSystemProps & MantineStylesAPIProps

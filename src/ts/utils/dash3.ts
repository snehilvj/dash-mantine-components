...
export const newRenderDashComponent = (
    component: any,
    index?: number | null,
    basePath?: any[]
) => {
    ...
    if (Array.isArray(component)) {
        return component.map((item, i) =>
            newRenderDashComponent(item, i, [...(basePath || []), i, 'props'])
        );
    }
    ...
    return createElement(
        (window as any).dash_component_api.ExternalWrapper,
        allProps
    );
};

export const newRenderDashComponents = (
    props: any,

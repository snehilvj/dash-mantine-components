...
def test_001ti_timeinput(dash_duo):
    ...
    #time.sleep(60)
    elem.send_keys("01", Keys.ARROW_RIGHT, "01")
    ...
    dash_duo.wait_for_text_to_equal("#out-true", "01:01:00")
    ...
    dash_duo.wait_for_text_to_equal("#out-false", "01:01:00")
    ...
    dash_duo.wait_for_text_to_equal("#out-2000", "01:01:00")

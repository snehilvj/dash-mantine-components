...
def test_001sc_scrollarea_scrollto_px(dash_duo):
    app = Dash(__name__)
    ...
    controls = dmc.Group([
        dmc.NumberInput(label="Y position",  value=0, id="y-position"),
        dmc.NumberInput(label="X position",  value=0, id="x-position"),
    ])
...
def test_002sc_scrollarea_scrollto_percent(dash_duo):
    app = Dash(__name__)
    ...
    controls = dmc.Group([
        dmc.TextInput(label="Y position", id="y-position"),
        dmc.TextInput(label="X position", id="x-position"),
    ])
